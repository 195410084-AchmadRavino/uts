...
import id.ravino.achmad.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun calculateTip() {
        ...
        val snackBar = Snackbar.make(binding.layout, "Pengajuan HoeTank Success", Snackbar.LENGTH_SHORT).setAction(
            "UNDO", null
        )
        snackBar.show()
